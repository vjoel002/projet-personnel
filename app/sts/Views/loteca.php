...
<body>
    <a href="http://localhost/loteca/lotecaAlter">LotecaAlter</a><br><br>
    <a href="http://localhost/loteca/lotecasimples">Loteca simples</a>
    <h1>Pronostique pour loteca</h1>
    <form action="" method="POST">
        <div class="field textarea">
            <input type="text" name="word" id="word" placeholder="Digite o nome do time">
        </div>
        <div class="buttom-area">
            <button type="submit" name="smgSend" value=" ">  Converter</button>
        </div>
    </form>

    <form action="" method="POST">
        <div class="field2 textarea">
            <input type="text" name="number" id="number" placeholder="dd/mm/aaaa hh:ss" value="" >
        </div>
        <div class="buttom-area">
            <button type="submit" name="smgSend2" value=" ">  Calcular</button>
        </div>
    </form>
